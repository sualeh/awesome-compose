---
name: orthanc
description: Starts and stops a local Orthanc DICOM server with Docker Compose. Use this skill when the user asks to start Orthanc, start a DICOM server, or work with DICOM files. Exposes a web UI on http://localhost:8042 and a DICOM endpoint on port 4242.
license: Apache-2.0
metadata:
  author: sualeh
  version: "1.0"
...
- `compose.yaml`: Compose definition exposing Orthanc UI on http://localhost:8042 and DICOM on port 4242
