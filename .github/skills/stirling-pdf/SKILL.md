---
name: stirling-pdf
description: Starts and stops a local Stirling PDF container with Docker Compose. Use this skill when the user asks to start Stirling PDF, or to work with PDF files locally (convert, merge, split, OCR). Stirling PDF runs entirely on-device and exposes a web UI on http://localhost:8080.
license: Apache-2.0
metadata:
  author: sualeh
  version: "1.0"
